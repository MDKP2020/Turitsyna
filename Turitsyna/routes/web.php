...
Route::get('/db', [StudentController::class, 'getStudentsAndGroups']);
Route::get('/db/{group_id}', [StudentController::class, 'getStudentsFromGroup']);
Route::get('/tr', [TransferController::class, 'createTransferList']);
